                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('phone_access')
                                        <a class="dropdown-item" href="{{ route('frontend.phones.index') }}">
                                    ...
                                    @endcan
                                    @can('province_access')
                                        <a class="dropdown-item" href="{{ route('frontend.provinces.index') }}">
                                            {{ trans('cruds.province.title') }}
                                        </a>
                                    @endcan
                                    @can('postal_code_access')
                                        <a class="dropdown-item" href="{{ route('frontend.postal-codes.index') }}">
                                            {{ trans('cruds.postalCode.title') }}
                                        </a>
                                    @endcan
                                    @can('blood_group_access')
                                        <a class="dropdown-item" href="{{ route('frontend.blood-groups.index') }}">
                                            {{ trans('cruds.bloodGroup.title') }}
                                        </a>
                                    @endcan
                                    @can('religion_access')
                                        <a class="dropdown-item" href="{{ route('frontend.religions.index') }}">
                                            {{ trans('cruds.religion.title') }}
                                        </a>
                                    @endcan
                                    @can('caste_access')
                                        <a class="dropdown-item" href="{{ route('frontend.castes.index') }}">
