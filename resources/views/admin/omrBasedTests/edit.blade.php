...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.omr-based-tests.update", [$omrBasedTest->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="series">{{ trans('cruds.omrBasedTest.fields.series') }}</label>
                <input class="form-control {{ $errors->has('series') ? 'is-invalid' : '' }}" type="text" name="series" id="series" value="{{ old('series', $omrBasedTest->series) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $omrBasedTest->type) }}" required>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('negative_mark') ? 'is-invalid' : '' }}" type="number" name="negative_mark" id="negative_mark" value="{{ old('negative_mark', $omrBasedTest->negative_mark) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correct_mark') ? 'is-invalid' : '' }}" type="number" name="correct_mark" id="correct_mark" value="{{ old('correct_mark', $omrBasedTest->correct_mark) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_question') ? 'is-invalid' : '' }}" type="number" name="total_question" id="total_question" value="{{ old('total_question', $omrBasedTest->total_question) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('target_year') ? 'is-invalid' : '' }}" type="text" name="target_year" id="target_year" value="{{ old('target_year', $omrBasedTest->target_year) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('test_date') ? 'is-invalid' : '' }}" type="text" name="test_date" id="test_date" value="{{ old('test_date', $omrBasedTest->test_date) }}">
