    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.students.update", [$student->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parents_contact') ? 'is-invalid' : '' }}" type="text" name="parents_contact" id="parents_contact" value="{{ old('parents_contact', $student->parents_contact) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_of_joining') ? 'is-invalid' : '' }}" type="text" name="date_of_joining" id="date_of_joining" value="{{ old('date_of_joining', $student->date_of_joining) }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('image_verified') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="image_verified" id="image_verified" value="1" {{ $student->image_verified || old('image_verified', 0) === 1 ? 'checked' : '' }} required>
