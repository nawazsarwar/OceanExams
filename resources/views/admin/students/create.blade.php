    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.students.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('enrollment_no') ? 'is-invalid' : '' }}" type="text" name="enrollment_no" id="enrollment_no" value="{{ old('enrollment_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_card_no') ? 'is-invalid' : '' }}" type="text" name="id_card_no" id="id_card_no" value="{{ old('id_card_no', '') }}">
