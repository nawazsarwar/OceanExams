...
@can('fees_structure_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.fees-structures.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-FeesStructure">
            <thead>
                <tr>
                    <th width="10">
...
@can('fees_structure_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.fees-structures.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.fees-structures.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-FeesStructure').DataTable(dtOverrideGlobals);
