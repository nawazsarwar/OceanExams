    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.questions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('affiliationer') ? 'is-invalid' : '' }}" name="affiliationer_id" id="affiliationer_id">
                    @foreach($affiliationers as $id => $entry)
                        <option value="{{ $id }}" {{ old('affiliationer_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paper') ? 'is-invalid' : '' }}" type="text" name="paper" id="paper" value="{{ old('paper', '') }}">
                @if($errors->has('paper'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('question_no') ? 'is-invalid' : '' }}" type="text" name="question_no" id="question_no" value="{{ old('question_no', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_options') ? 'is-invalid' : '' }}" type="number" name="no_of_options" id="no_of_options" value="{{ old('no_of_options', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('option_1') ? 'is-invalid' : '' }}" name="option_1" id="option_1">{!! old('option_1') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('option_2') ? 'is-invalid' : '' }}" name="option_2" id="option_2">{!! old('option_2') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('option_3') ? 'is-invalid' : '' }}" name="option_3" id="option_3">{!! old('option_3') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('option_4') ? 'is-invalid' : '' }}" name="option_4" id="option_4">{!! old('option_4') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('option_5') ? 'is-invalid' : '' }}" name="option_5" id="option_5">{!! old('option_5') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('option_6') ? 'is-invalid' : '' }}" name="option_6" id="option_6">{!! old('option_6') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('correct_option') ? 'is-invalid' : '' }}" name="correct_option" id="correct_option">{!! old('correct_option') !!}</textarea>
