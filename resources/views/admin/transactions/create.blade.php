    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transactions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payable') ? 'is-invalid' : '' }}" type="number" name="payable" id="payable" value="{{ old('payable', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_cycle') ? 'is-invalid' : '' }}" type="number" name="payment_cycle" id="payment_cycle" value="{{ old('payment_cycle', '') }}" step="1" required>
