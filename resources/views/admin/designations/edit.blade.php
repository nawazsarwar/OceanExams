    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.designations.update", [$designation->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $designation->code) }}">
                @if($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pay_grade') ? 'is-invalid' : '' }}" type="text" name="pay_grade" id="pay_grade" value="{{ old('pay_grade', $designation->pay_grade) }}">
