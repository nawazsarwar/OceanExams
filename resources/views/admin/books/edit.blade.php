    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.books.update", [$book->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author') ? 'is-invalid' : '' }}" type="text" name="author" id="author" value="{{ old('author', $book->author) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('copies') ? 'is-invalid' : '' }}" type="text" name="copies" id="copies" value="{{ old('copies', $book->copies) }}">
                @if($errors->has('copies'))
                    <span class="text-danger">{{ $errors->first('copies') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('data') ? 'is-invalid' : '' }}" name="data" id="data">{{ old('data', $book->data) }}</textarea>
                @if($errors->has('data'))
