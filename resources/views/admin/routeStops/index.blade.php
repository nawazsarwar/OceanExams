...
@can('route_stop_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.route-stops.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-RouteStop">
            <thead>
                <tr>
                    <th width="10">
...
@can('route_stop_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.route-stops.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.route-stops.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-RouteStop').DataTable(dtOverrideGlobals);
