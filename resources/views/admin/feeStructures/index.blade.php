...
@can('fee_structure_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.fee-structures.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-FeeStructure">
            <thead>
                <tr>
                    <th width="10">
...
@can('fee_structure_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.fee-structures.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.fee-structures.index') }}",
    columns: [
