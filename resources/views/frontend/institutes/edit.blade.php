                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.institutes.update", [$institute->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address" id="address">{{ old('address', $institute->address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="header_background_color" id="header_background_color" value="{{ old('header_background_color', $institute->header_background_color) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="footer_background_color" id="footer_background_color" value="{{ old('footer_background_color', $institute->footer_background_color) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="about" id="about">{!! old('about', $institute->about) !!}</textarea>
                            @if($errors->has('about'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('about') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $institute->remarks) }}</textarea>
