                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.partners.update", [$partner->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subdomain" id="subdomain" value="{{ old('subdomain', $partner->subdomain) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="hostname" id="hostname" value="{{ old('hostname', $partner->hostname) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="public_email" id="public_email" value="{{ old('public_email', $partner->public_email) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="public_mobile" id="public_mobile" value="{{ old('public_mobile', $partner->public_mobile) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address" id="address">{{ old('address', $partner->address) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="header_background_color" id="header_background_color" value="{{ old('header_background_color', $partner->header_background_color) }}">
