                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.students.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="parents_contact" id="parents_contact" value="{{ old('parents_contact', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_of_joining" id="date_of_joining" value="{{ old('date_of_joining') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="image_verified" id="image_verified" value="1" {{ old('image_verified', 0) == 1 ? 'checked' : '' }}>
