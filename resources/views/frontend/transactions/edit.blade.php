                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.transactions.update", [$transaction->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="payable" id="payable" value="{{ old('payable', $transaction->payable) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="discount" id="discount" value="{{ old('discount', $transaction->discount) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="paid" id="paid" value="{{ old('paid', $transaction->paid) }}" step="0.01" required>
                            @if($errors->has('paid'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('paid') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="balance" id="balance" value="{{ old('balance', $transaction->balance) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="due_date" id="due_date" value="{{ old('due_date', $transaction->due_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="payment_date" id="payment_date" value="{{ old('payment_date', $transaction->payment_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remark" id="remark">{{ old('remark', $transaction->remark) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="payment_cycle" id="payment_cycle" value="{{ old('payment_cycle', $transaction->payment_cycle) }}" step="1" required>
