                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.questions.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="paper" id="paper" value="{{ old('paper', '') }}">
                            @if($errors->has('paper'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('paper') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="question_no" id="question_no" value="{{ old('question_no', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="no_of_options" id="no_of_options" value="{{ old('no_of_options', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="option_1" id="option_1">{!! old('option_1') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="option_2" id="option_2">{!! old('option_2') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="option_3" id="option_3">{!! old('option_3') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="option_4" id="option_4">{!! old('option_4') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="option_5" id="option_5">{!! old('option_5') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="option_6" id="option_6">{!! old('option_6') !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="correct_option" id="correct_option">{!! old('correct_option') !!}</textarea>
