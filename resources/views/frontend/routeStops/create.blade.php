    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.route-stops.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fare" id="fare" value="{{ old('fare', '') }}" step="0.01">
                            @if($errors->has('fare'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fare') }}
                                </div>
