                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.provinces.update", [$province->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $province->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="remarks" id="remarks">{{ old('remarks', $province->remarks) }}</textarea>
