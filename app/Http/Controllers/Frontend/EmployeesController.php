...
class EmployeesController extends Controller
{
    ...
    public function index()
    {
        ...
        $employees = Employee::with(['subjects', 'designation', 'employee_type', 'institution', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.employees.create', compact('designations', 'employee_types', 'institutions', 'subjects'));
    }
    ...
    public function edit(Employee $employee)
    {
        ...
        return view('frontend.employees.edit', compact('designations', 'employee', 'employee_types', 'institutions', 'subjects'));
    }
