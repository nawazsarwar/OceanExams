...
class AddressesApiController extends Controller
{
    public function index()
    {
        ...
        return new AddressResource(Address::with(['postal_code', 'province', 'country', 'user'])->get());
    }
    ...
    public function show(Address $address)
    {
        ...
        return new AddressResource($address->load(['postal_code', 'province', 'country', 'user']));
    }
