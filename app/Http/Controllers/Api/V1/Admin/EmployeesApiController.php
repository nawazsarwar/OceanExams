...
class EmployeesApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new EmployeeResource(Employee::with(['subjects', 'designation', 'employee_type', 'institution', 'user'])->get());
    }
    ...
    public function show(Employee $employee)
    {
        ...
        return new EmployeeResource($employee->load(['subjects', 'designation', 'employee_type', 'institution', 'user']));
    }
